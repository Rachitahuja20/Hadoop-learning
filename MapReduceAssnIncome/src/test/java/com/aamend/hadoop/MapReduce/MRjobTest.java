...
import com.aamend.hadoop.MapReduce.CountryIncomeMapper;

//import com.aamend.hadoop.MR_Realdata.ReducerTemp1;

public class MRjobTest {
  MapDriver<Object, Text, CompositeKeyWritable, NullWritable> mapDriver;
  ...
  // k.setCountryName("Albania ");
  // k.setIncome(3477.27494354761);
  //
