...
public class CountryIncomeConf1 {
  ...
  public static void main(String[] args) throws IOException,
    ...
    Job job = new Job(conf, "CountryIncomeConf1");
    job.setJarByClass(CountryIncomeConf1.class);
    ...
    // Setup MapReduce
    job.setMapperClass(CountryIncomeMapper1.class);
